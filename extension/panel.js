...
(function () {
  ...
  var REGION_LABELS = {
    'europe':        'Europe (Lower Carbon)',
    'north-america': 'North America',
    'asia':          'Asia (Higher Carbon)',
    'middle-east':   'Middle East (High Carbon)',
    'africa':        'Africa',
  ...
  // location mode state
  var currentLocationMode = 'provider'; // 'provider' or 'user-region'
  ...
  function setMetrics(payload) {
    ...
    if (els.sessionWaterValue)  els.sessionWaterValue.textContent  = fmt(typeof sess.water  === 'number' ? sess.water  : 0, 2);
